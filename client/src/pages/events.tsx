  ...
  return (
    <div className="flex-1 flex flex-col pb-20">
      <header className="px-4 pt-12 pb-4 bg-neutral-900 sticky top-0 z-10">
        <h1 className="font-display font-bold text-2xl text-white mb-4">Events</h1>
        ...
        <div className="flex space-x-2">
          ...
          <Button variant="outline" size="icon" className="bg-neutral-800 border-0 h-12 w-12 rounded-xl">
      ...
      <main className="flex-1 px-4">
        <div className="mb-6">
          <h2 className="font-display font-semibold text-xl text-white mb-4">Upcoming Events</h2>
